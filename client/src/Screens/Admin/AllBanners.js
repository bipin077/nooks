          ...
          <tbody>
              { !isFetching && data.banners.map((banner, index) =>
                <tr key={index}>
                  ...
                  <td width="10%"><img src={ `/upload/banners/${banner.image}` } style={{"width" : "70%"}} className="rounded"  /></td>
                  ...
                  <td width="1%"><Link to={ `/admin/editBanner/${banner._id}`}><i className="fas fa-edit mr-10"></i></Link></td>
                  <td width="1%"><i className="fas fa-trash mr-10" onClick={()=>deleteBanner(banner._id)}></i></td>
                </tr>
              )}
